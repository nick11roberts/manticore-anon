...
class LanguageModel(nn.Module):
    ...
    def __init__(self,
        ...
        *args, **kwargs
        ...
        self.max_length = max_length # EDIT
        self.position_embeds_func = position_embeds # EDIT
        ...
        for layer, layer_cfg in zip(layers, layer_cfgs):
            # EDIT: if it's identity don't add a norm
            if layer==nn.Identity:
                self.model.append(layer(**layer_cfg))
            else:
    ...
    def reinit_embedding(self, dim=None, max_length=None,vocab_size=None): # EDIT
        dim = self.dim if dim is None else dim
        max_length = self.max_length if max_length is None else max_length
        vocab_size = self.vocab_size if vocab_size is None else vocab_size
        position_embeds = self.position_embeds_func
